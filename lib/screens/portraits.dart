...
class PortraitsScreen extends StatefulWidget {
  const PortraitsScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _PortraitsScreenState createState() => _PortraitsScreenState();
}

class _PortraitsScreenState extends State<PortraitsScreen> {
  ...
  Future<void> _loadImages({int limit = 20}) async {
    ...
    Reference ref = storage.ref('portraits');
